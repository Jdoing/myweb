...
<HEAD>
	...
	<link rel="stylesheet" href="/WEB-INF/zTree/css/demo.css" type="text/css">
	<link rel="stylesheet" href="/WEB-INF/zTree/css/zTreeStyle/zTreeStyle.css" type="text/css">
	<script type="text/javascript" src="/WEB-INF/zTree/js/jquery-1.4.4.min.js"></script>
	<script type="text/javascript" src="/WEB-INF/zTree/js/jquery.ztree.core-3.5.js"></script>
