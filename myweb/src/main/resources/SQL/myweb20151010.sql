...
INSERT INTO `sys_resource` VALUES (1,'user','用户管理','/api/user/view'),(2,'role','角色管理','/api/role/view'),(3,'resource','资源管理','/api/resource/view'),(4,'operation','操作权限管理','/api/operation/view');
...
-- Dump completed on 2015-10-10 15:47:03
